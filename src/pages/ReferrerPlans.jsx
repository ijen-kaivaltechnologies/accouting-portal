		...
		<div>
			...
			<div style={{ marginBottom: "28px" }}>
				...
				<p style={{ color: "#64748b", fontSize: "14px", marginTop: "4px" }}>
					Choose a service plan to create a new referral and earn your
					commission.
				</p>
			</div>
							...
							<div>
								...
								<div
									...
									<span
										...
										₹{parseFloat(plan.original_price).toLocaleString("en-IN")}
									</span>
							...
							<div>
								...
								<div
									...
									<span
										...
										Your cashback ₹
										{parseFloat(plan.commission_amount).toLocaleString("en-IN")}
									</span>
								</div>
